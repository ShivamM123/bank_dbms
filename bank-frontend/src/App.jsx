    ...
    <div className="app-container">
      <header className="app-header">
        ...
        <nav className="nav-links">
          <span className={`nav-link ${activeTab === 'dashboard' ? 'active' : ''}`} onClick={() => setActiveTab('dashboard')} style={{ cursor: 'pointer' }}>Dashboard</span>
          <span className="nav-link disabled">Concurrency Lab 🔒</span>
          <span className={`nav-link ${activeTab === 'recovery' ? 'active-red' : ''}`} onClick={() => setActiveTab('recovery')} style={{ cursor: 'pointer' }}>Recovery Lab</span>
        </nav>
      </header>
